...
class Screener extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Row>
                    <img src={logo} alt="logo" style={{width: "100px", height: "100px", paddingTop: "1%", paddingLeft: "1%"}}/>
                </Row>
                <Row style={{ paddingTop: "10%" }} justify="space-around" align="middle">
                    ...
                    <Col span={16} justify="top" className="steps-content">
                        {current === 0 && (
                            <div>
                                <Button type='text' value="spinoff" style={{ paddingRight: "10%", paddingBottom: "10%"}} onClick={this.selectScreener}>
                                    <img src={spinoff} id="spinoff" alt="Spinoff" style={{ width: "200px", height: "200px"}}/>
                                    <br />Spinoff
                                </Button>
                                <Button type='text' value="magic_formula" style={{ paddingRight: "10%", paddingBottom: "10%" }} onClick={this.selectScreener}>
                                    <img src={magicFormula} id="magic_formula" alt="Magic Formula" style={{ width: "200px", height: "200px" }} />
                                    <br />Magic Formula
                                </Button>
                                <Button type='text' value="share_cannibals" style={{ paddingRight: "10%", paddingBottom: "10%" }} onClick={this.selectScreener}>
